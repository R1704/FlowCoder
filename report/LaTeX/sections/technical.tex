...
\paragraph{\green{Parameterisation}}
...
% Therefore, I am using DeepSynth's framework.

\subsection{\green{DeepSynth}}
...
\subsubsection{\orange{DeepSynth Framework}}
...
% The GFlowNet is $q(z|x) = \pi_\theta(z|x)$ and approximates the posterior distribution.
% So we have the joint optimization problem of training both models. 




\subsubsection{\orange{Expectation-Maximisation}}
...
\paragraph{\green{E-step Loss Thresholding}}
...
\subsection{\orange{Parameterisation}}
...
\paragraph{\orange{Syntactic constraints}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\orange{Results}}

\subsection{\red{Training}}
\begin{itemize}
...
\subsubsection{\green{Complexity Analysis}}
