...
\addbibresource{../auxiliary/ref.bib}
...
\newcommandx{\story}[2][1=]{\todo[inline, linecolor=black,backgroundcolor=white!25,bordercolor=black,#1]{#2}}
\newcommandx{\conclusion}[2][1=]{\todo[inline, linecolor=Violet,backgroundcolor=Violet!25,bordercolor=Violet,#1]{#2}}
\newcommandx{\thiswillnotshow}[2][1=]{\todo[disable,#1]{#2}} % putting disable in the options turns off todos globally
%

% To keep track of progress (highlight sections, e.g. \section{\red{Introduction}})
...
\usepackage{tikz}
\usetikzlibrary{fit, positioning, shapes, shapes.geometric, arrows, calc, shadows, arrows.meta, decorations.pathreplacing}
...
% \usepackage[acronym, short-first]{glossaries-extra}
\makeglossaries
