...
from src.sequential.deepsynth.type_system import Type, PolymorphicType, PrimitiveType, Arrow, List, UnknownType
...
class Function(Program):
    ...
    def derive_with_constants(self, constants):
        return Function(self.function.derive_with_constants(constants),
                        [argument.derive_with_constants(constants) for argument in self.arguments], self.type,
                        self.probability)
