...
class Training:
    ...
    def replay(self, correct_programs):
        ...
        replay_loss = -total_forwards.mean() * 10  # TODO: Try weighting it (e.g. -10 * ...)
    ...
    def train(self):
        ...
        for depth in tqdm(range(self.min_program_depth, self.data.max_program_depth + 1), position=0, desc='depth',
